            ...
            <v-container>
              ...
              <v-row no-gutters>
                ...
                <v-flex xs12 sm6>
                  <v-checkbox
                    v-model="root_folder"
                    :label="$t('torrent.createsubfolder')"
                    hide-details
                  />
                </v-flex>
                <v-flex xs12 sm6>
        ...
        <v-form>
          <v-card-actions class="justify-center">
            <v-btn
              ...
              @click="submit"
            >
              {{ $t('navbar.topActions.addTorrent') }}
            </v-btn>
